...
$layout = new TLayout("print_bootstrap", "BreezeOrange", "MobileOrange");
$layout->version = 3;
...
$page_layouts["hris_leavecredit_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "hris_leavecredit" );
