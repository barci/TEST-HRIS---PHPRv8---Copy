...
$page_layouts["hris_educationprofile_print"] = $layout;
...
$page_layouts["hris_personnel_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "hris_educationprofile" );
