...
function checkTableName($shortTName, $type=false)
{
	...
	if ("hris_affiliation" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("hris_educationprofile" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("hris_job" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("hris_licert" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("hris_personnel" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("hris_tito" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("hris_trainings" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("hris_user" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Active_Personnel" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Inactive_Personnel" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("hris_journey" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("hris_vacancy" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("DeptUnit" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("hris_files" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("User_Manager" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Job_Titles" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	return false;
}
...
{
	$arr = array();
		$arr[]="hris_affiliation";
		$arr[]="hris_educationprofile";
		$arr[]="hris_job";
		$arr[]="hris_licert";
		$arr[]="hris_personnel";
		$arr[]="hris_tito";
		$arr[]="hris_trainings";
		$arr[]="hris_user";
		$arr[]="Active Personnel";
		$arr[]="Inactive Personnel";
		$arr[]="hris_journey";
		$arr[]="hris_vacancy";
		$arr[]="DeptUnit";
		$arr[]="hris_files";
...
function GetUserPermissions($table="")
{
	...
	if(!$table)
		$table = $strTableName;
	$permissions = "";
	if($table=="hris_affiliation")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="hris_educationprofile")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="hris_job")
	...
	if($table=="hris_licert")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="hris_personnel")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="hris_tito")
	...
	if($table=="Active Personnel")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="Inactive Personnel")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="hris_journey")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="hris_vacancy")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="DeptUnit")
...
function AfterFBLogIn($pUsername, $pPassword, &$pageObject = null)
{
	...
	$strSQL = "select * from ".$connection->addTableWrappers("hris_user")
