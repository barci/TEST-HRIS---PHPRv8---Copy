...
require_once("include/hris_leavecredit_variables.php");
...
$layout = new TLayout("edit_bootstrap", "BreezeOrange", "MobileOrange");
$layout->version = 3;
...
$page_layouts["hris_leavecredit_edit"] = $layout;
...
$layout = new TLayout("list_bootstrap1", "BreezeOrange", "MobileOrange");
$layout->version = 3;
	$layout->bootstrapTheme = "united";
...
$page_layouts["hris_leavecredit_list"] = $layout;
