...
$layout = new TLayout("edit_bootstrap", "OfficeOrange", "MobileOrange");
$layout->version = 3;
...
$page_layouts["User_Manager_edit"] = $layout;
...
$layout = new TLayout("list_bootstrap1", "OfficeOrange", "MobileOrange");
$layout->version = 3;
	$layout->bootstrapTheme = "united";
...
$page_layouts["User_Manager_list"] = $layout;
