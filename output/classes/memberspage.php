...
{	
	...
	function fillMembers()
	{
		...
		$sql = "select ". $this->connection->addFieldWrappers( "" )
			...
			." from ". $this->connection->addTableWrappers( "ugmembers" ) 
	...
	{
		// It's expected that $this->tName is equal to 'admin_members' so the page's db connection is used #9875		
		$membersWTableName = $this->connection->addTableWrappers( "ugmembers" );
		$userNameWFieldName = $this->connection->addFieldWrappers( "" );
		$groupIdWFieldName = $this->connection->addFieldWrappers( "" );
