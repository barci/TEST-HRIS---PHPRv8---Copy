...
class ConnectionManager
{
	...
	{
		return $this->byId( "hris_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "hris_at_localhost";
		$data["connName"] = "hris at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;hris;;1"; //currently unused
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "hris";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=hris;OPTION=3";
		...
		$connectionsData["hris_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["hris_affiliation"] = "hris_at_localhost";
		$connectionsIds["hris_educationprofile"] = "hris_at_localhost";
		$connectionsIds["hris_job"] = "hris_at_localhost";
		$connectionsIds["hris_licert"] = "hris_at_localhost";
		$connectionsIds["hris_personnel"] = "hris_at_localhost";
		$connectionsIds["hris_tito"] = "hris_at_localhost";
		$connectionsIds["hris_trainings"] = "hris_at_localhost";
		$connectionsIds["hris_user"] = "hris_at_localhost";
		$connectionsIds["Active Personnel"] = "hris_at_localhost";
		$connectionsIds["Inactive Personnel"] = "hris_at_localhost";
		$connectionsIds["hris_journey"] = "hris_at_localhost";
		$connectionsIds["hris_vacancy"] = "hris_at_localhost";
		$connectionsIds["DeptUnit"] = "hris_at_localhost";
		$connectionsIds["hris_files"] = "hris_at_localhost";
		$connectionsIds["User Manager"] = "hris_at_localhost";
		$connectionsIds["Job Titles"] = "hris_at_localhost";
