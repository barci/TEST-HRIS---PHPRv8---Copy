...
class ProjectSettings
{
	...
	{
		$this->_table = $table;
		global $tables_data, $field_labels, $fieldToolTips, $page_titles, $detailsTablesData, $masterTablesData, $tableEvents;
	...
	function getFieldData( $field, $key )
	{
		...
		$isSeparateSettings = $this->isSeparate($field);
		...
		switch($settingType)
		{
			case SETTING_TYPE_VIEW:
				...
				if($isSeparateSettings && $this->_pageMode == EDIT_INLINE)
				{
					$viewPage = PAGE_LIST;
				}
	...
	{
		return $this->getTableType() == PAGE_DASHBOARD ? $this->getDashMainFieldData($field, "EditFormat") : $this->getFieldData($field, "EditFormat");
	}
	...
	{
		return $this->getNType() == DASHBOARD_SEARCH ? $this->getDashFieldData($field, "ShowTime") : $this->getFieldData($field, "ShowTime");
	}

	function lookupControlType($field)
	{
		return $this->getNType() == DASHBOARD_SEARCH ? $this->getDashFieldData($field, "LCType") : $this->getFieldData($field, "LCType");
	}
	...
	{
		return $this->getNType() == DASHBOARD_SEARCH ? $this->getDashFieldData($field, "UseCategory") : $this->getFieldData($field, "UseCategory");
	}

	//	is Lookup wizard with multiple selection
	function multiSelect($field)
	{
		return $this->getNType() == DASHBOARD_SEARCH ? $this->getDashFieldData($field, "Multiselect") : $this->getFieldData($field, "Multiselect");
	}

	// Lookup wizard select size
	function selectSize($field)
	{
		return $this->getNType() == DASHBOARD_SEARCH ? $this->getDashFieldData($field, "SelectSize") : $this->getFieldData($field, "SelectSize");
	}
	...
	{
		return $this->getNType() == DASHBOARD_SEARCH ? $this->getDashFieldData($field, "LookupType") : $this->getFieldData($field, "LookupType");
	}

	//Get lookup table name
	function getLookupTable($field)
	{
		return $this->getNType() == DASHBOARD_SEARCH ? $this->getDashFieldData($field, "LookupTable") : $this->getFieldData($field, "LookupTable");
	}
	...
	{
		return $this->getNType() == DASHBOARD_SEARCH ? $this->getDashFieldData($field, "LinkField") : $this->getFieldData($field, "LinkField");
	}
	...
	{
		return $this->getNType() == DASHBOARD_SEARCH ? $this->getDashFieldData($field, "DisplayField") : $this->getFieldData($field, "DisplayField");
	}
	
	function getCustomDisplay($field)
	{
		return $this->getNType() == DASHBOARD_SEARCH ? $this->getDashFieldData($field, "CustomDisplay") : $this->getFieldData($field, 'CustomDisplay');
	}
	...
	{
		return $this->getNType() == DASHBOARD_SEARCH ? $this->getDashFieldData($field, "FormatTimeAttrs") : $this->getFieldData($field, "FormatTimeAttrs");
	}
	...
	{
		return $this->getNType() == DASHBOARD_SEARCH ? $this->getAllSearchFields() :  $this->getTableData('.advSearchFields');
	}
	...
	function getNType()
	{
		return $this->getTableData(".nType");
	}
	...
	{
		return $this->getNType() == DASHBOARD_SEARCH ? $this->getDashFieldData($field, "DateEditType") : $this->getFieldData($field, "DateEditType");                  
	}

	function getHTML5InputType($field)
	{
		return $this->getNType() == DASHBOARD_SEARCH ? $this->getDashFieldData($field, "HTML5InuptType") : $this->getFieldData($field, "HTML5InuptType");
	}
	...
	{
		return $this->getNType() == DASHBOARD_SEARCH ? $this->getDashFieldData($field, "EditParams") : $this->getFieldData($field, "EditParams");
	}
	
	
	function getControlWidth($field)
	{
		return $this->getNType() == DASHBOARD_SEARCH ? $this->getDashFieldData($field, "controlWidth") : $this->getFieldData($field, "controlWidth");
	}
	...
	{
		return $this->getTableType() == PAGE_DASHBOARD ? $this->getDashMainFieldData($field, "searchOptionsList") : $this->getFieldData($field, "searchOptionsList");
	}
	
	
	function getDefaultSearchOption($field)
	{
		$defaultOpt = $this->getTableType() == PAGE_DASHBOARD ? $this->getDashMainFieldData($field, "defaultSearchOption") : $this->getFieldData($field, "defaultSearchOption");
...
function GetTableURL($table = "")
{
	...
	if(!$table)
		$table=$strTableName;
	if("hris_affiliation" == $table) 
		return "hris_affiliation";
	if("hris_educationprofile" == $table) 
		return "hris_educationprofile";
	if("hris_job" == $table) 
		return "hris_job";
	if("hris_licert" == $table) 
		return "hris_licert";
	if("hris_personnel" == $table) 
		return "hris_personnel";
	if("hris_tito" == $table) 
		return "hris_tito";
	if("hris_trainings" == $table) 
		return "hris_trainings";
	if("hris_user" == $table) 
		return "hris_user";
	if("Active Personnel" == $table) 
		return "Active_Personnel";
	if("Inactive Personnel" == $table) 
		return "Inactive_Personnel";
	if("hris_journey" == $table) 
		return "hris_journey";
	if("hris_vacancy" == $table) 
		return "hris_vacancy";
	if("DeptUnit" == $table) 
		return "DeptUnit";
	if("hris_files" == $table) 
		return "hris_files";
	if("User Manager" == $table) 
		return "User_Manager";
	if("Job Titles" == $table) 
		return "Job_Titles";
...
{	
	...
	if(!$shortTName)
		return false;
	if("hris_affiliation" == $shortTName) 
		return "hris_affiliation";
	if("hris_educationprofile" == $shortTName) 
		return "hris_educationprofile";
	if("hris_job" == $shortTName) 
		return "hris_job";
	if("hris_licert" == $shortTName) 
		return "hris_licert";
	if("hris_personnel" == $shortTName) 
		return "hris_personnel";
	if("hris_tito" == $shortTName) 
		return "hris_tito";
	if("hris_trainings" == $shortTName) 
		return "hris_trainings";
	if("hris_user" == $shortTName) 
		return "hris_user";
	if("Active_Personnel" == $shortTName) 
		return "Active Personnel";
	if("Inactive_Personnel" == $shortTName) 
		return "Inactive Personnel";
	if("hris_journey" == $shortTName) 
		return "hris_journey";
	if("hris_vacancy" == $shortTName) 
		return "hris_vacancy";
	if("DeptUnit" == $shortTName) 
		return "DeptUnit";
	if("hris_files" == $shortTName) 
		return "hris_files";
	if("User_Manager" == $shortTName) 
		return "User Manager";
	if("Job_Titles" == $shortTName) 
		return "Job Titles";
}
