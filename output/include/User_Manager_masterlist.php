<?php
function DisplayMasterTableInfo_User_Manager($params)
{
	global $cman;
	...
	$layout = GetPageLayout("User_Manager", 'masterlist');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');
	
	$xt->displayPartial(GetTemplateName("User_Manager", "masterlist"));
}
