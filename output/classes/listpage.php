...
{	
	 ...
	 * @type bool
	 */
	public $isUseInlineAdd = false;
	
	/**
	 * If use Inline Edit on page or not
	 * @type bool
	 */
	public $isUseInlineEdit = false;
	...
	{	
		...
		return $this->connection->checkDBSubqueriesSupport() 
	 ...
	 * @param Array options
	 */
	function & createListPage($strTableName, $options)
	{
		...
		else if($params["mode"]==LIST_DETAILS || $params["mode"]==LIST_DASHDETAILS)
	...
	{
		$lookupSettings = ListPage::readMainTableSettingsFromRequest( $table );
		if( !$lookupSettings )
			return false;
