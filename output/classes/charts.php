...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("hris_affiliation" == $this->chrt_array['tables'][0])
			return true;
		if("hris_educationprofile" == $this->chrt_array['tables'][0])
			return true;
		if("hris_job" == $this->chrt_array['tables'][0])
			return true;
		if("hris_licert" == $this->chrt_array['tables'][0])
			return true;
		if("hris_personnel" == $this->chrt_array['tables'][0])
			return true;
		if("hris_tito" == $this->chrt_array['tables'][0])
			return true;
		if("hris_trainings" == $this->chrt_array['tables'][0])
			return true;
		if("hris_user" == $this->chrt_array['tables'][0])
			return true;
		if("hris_personnel" == $this->chrt_array['tables'][0])
			return true;
		if("hris_personnel" == $this->chrt_array['tables'][0])
			return true;
		if("hris_journey" == $this->chrt_array['tables'][0])
			return true;
		if("hris_vacancy" == $this->chrt_array['tables'][0])
			return true;
		if("hris_job" == $this->chrt_array['tables'][0])
			return true;
		if("hris_files" == $this->chrt_array['tables'][0])
			return true;
		if("hris_personnel" == $this->chrt_array['tables'][0])
			return true;
		if("hris_job" == $this->chrt_array['tables'][0])
	...
	{		
		...
		if ( $this->dashChart )
		{
			...
			return '<actions>'.$delimiter
				.'<action type="call" function="Runner.updateDetailsForDashboardChart">'.$delimiter
				.'<arg>'.my_json_encode( $masterKeysArr ).'</arg>'.$delimiter
