...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("hris_user");
}
...
class tDAL
{
	var $hris_affiliation;
	var $hris_educationprofile;
	var $hris_files;
	var $hris_job;
	var $hris_journey;
	var $hris_licert;
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "hris_affiliation", "varname" => "hris_affiliation", "connId" => "hris_at_localhost");
		$this->lstTables[] = array("name" => "hris_educationprofile", "varname" => "hris_educationprofile", "connId" => "hris_at_localhost");
		$this->lstTables[] = array("name" => "hris_files", "varname" => "hris_files", "connId" => "hris_at_localhost");
		$this->lstTables[] = array("name" => "hris_job", "varname" => "hris_job", "connId" => "hris_at_localhost");
		$this->lstTables[] = array("name" => "hris_journey", "varname" => "hris_journey", "connId" => "hris_at_localhost");
		$this->lstTables[] = array("name" => "hris_licert", "varname" => "hris_licert", "connId" => "hris_at_localhost");
		$this->lstTables[] = array("name" => "hris_personnel", "varname" => "hris_personnel", "connId" => "hris_at_localhost");
		$this->lstTables[] = array("name" => "hris_tito", "varname" => "hris_tito", "connId" => "hris_at_localhost");
		$this->lstTables[] = array("name" => "hris_trainings", "varname" => "hris_trainings", "connId" => "hris_at_localhost");
		$this->lstTables[] = array("name" => "hris_user", "varname" => "hris_user", "connId" => "hris_at_localhost");
		$this->lstTables[] = array("name" => "hris_vacancy", "varname" => "hris_vacancy", "connId" => "hris_at_localhost");
	}
