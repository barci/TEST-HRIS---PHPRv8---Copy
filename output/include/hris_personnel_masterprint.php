<?php
function DisplayMasterTableInfoForPrint_hris_personnel($params)
{
	global $cman;
	...
	$layout = GetPageLayout("hris_personnel", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("hris_personnel", "masterprint"));
}
