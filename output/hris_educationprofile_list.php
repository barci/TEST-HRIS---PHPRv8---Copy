...
$page_layouts["hris_educationprofile_list"] = $layout;
...
$layout = new TLayout("masterlist", "FusionDeliciousLavender", "MobileDeliciousLavender");
$layout->version = 2;
...
$page_layouts["hris_personnel_masterlist"] = $layout;
