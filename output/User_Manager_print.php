...
require_once("include/User_Manager_variables.php");
...
$layout = new TLayout("print_bootstrap", "OfficeOrange", "MobileOrange");
$layout->version = 3;
...
$page_layouts["User_Manager_print"] = $layout;
...
$layout->blocks["top"][] = "grid";
$page_layouts["hris_user_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "User Manager" );
